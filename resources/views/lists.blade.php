...
<body class="m-0 bg-gradient-to-t from-purple-400 to-sky-200 bg-no-repeat bg-fixed box-border">
    ...
    <div class="w-72 h-64 bg-gradient-to-t from-purple-200 to-sky-100 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 top-72 rounded-md absolute flex flex-col items-center z-50" id="create-panel">
    ...
    <script>
        ...
        createListButton.addEventListener('click', () => {
            ...
            createPanel.classList.toggle('shadow-lg');
